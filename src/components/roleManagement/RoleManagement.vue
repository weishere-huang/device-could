      ...
      <div class="right">
        ...
        <div>
          <div class="system">
            ...
            <span class="sright">
              <el-checkbox
                :indeterminate="system.isIndeterminate"
                v-model="system.checkAll"
                @change="systemCheckAllChange"
              >全选</el-checkbox>
            </span>
          </div>
          <div class="system-slist">
            <el-checkbox-group
              v-model="system.checkedSystem"
              @change="systemCheckedCitiesChange"
            >
              <el-checkbox
                v-for="item in system.systemList"
                :label="item"
                :key="item"
              >{{item}}</el-checkbox>
            </el-checkbox-group>
        ...
        <div>
          <div class="information">
            <span class="sleft">
              <i
                class="iconfont icon-jia"
                @click="informationShow"
                v-show="information.sShow"
              ></i>
              <i
                class="iconfont icon-jian"
                @click="informationHide"
                v-show="information.sHide"
              ></i>
              数据分析
            </span>
            <span class="sright">
              <el-checkbox
                :indeterminate="information.isIndeterminate"
                v-model="information.checkAll"
                @change="informationCheckAllChange"
              >全选</el-checkbox>
            </span>
          </div>
          <div class="information-slist">
            <el-checkbox-group
              v-model="information.checkedSystem"
              @change="informationCheckedCitiesChange"
            >
              <el-checkbox
                v-for="item in information.systemList"
                :label="item"
                :key="item"
              >{{item}}</el-checkbox>
            </el-checkbox-group>
          ...
          <div class="equipment">
            <span class="sleft">
              <i
                class="iconfont icon-jia"
                @click="equipmentShow"
                v-show="equipment.sShow"
              ></i>
              <i
                class="iconfont icon-jian"
                @click="equipmentHide"
                v-show="equipment.sHide"
              ></i>
              设备管理
            </span>
            <span class="sright">
              <el-checkbox
                :indeterminate="equipment.isIndeterminate"
                v-model="equipment.checkAll"
                @change="equipmentCheckAllChange"
              >全选</el-checkbox>
            </span>
          </div>
          <div class="equipment-slist">
            <el-checkbox-group
              v-model="equipment.checkedSystem"
              @change="equipmentCheckedCitiesChange"
            >
              <el-checkbox
                v-for="item in equipment.systemList"
                :label="item"
                :key="item"
              >{{item}}</el-checkbox>
            </el-checkbox-group>
          ...
          <div class="personnel">
            <span class="sleft">
              <i
                class="iconfont icon-jia"
                @click="personnelShow"
                v-show="personnel.sShow"
              ></i>
              <i
                class="iconfont icon-jian"
                @click="personnelHide"
                v-show="personnel.sHide"
              ></i>
              人员档案管理
            </span>
            <span class="sright">
              <el-checkbox
                :indeterminate="personnel.isIndeterminate"
                v-model="personnel.checkAll"
                @change="personnelCheckAllChange"
              >全选</el-checkbox>
            </span>
          </div>
          <div class="personnel-slist">
            <el-checkbox-group
              v-model="personnel.checkedSystem"
              @change="personnelCheckedCitiesChange"
            >
              <el-checkbox
                v-for="item in personnel.systemList"
                :label="item"
                :key="item"
              >{{item}}</el-checkbox>
            </el-checkbox-group>
        ...
        <div>
          <div class="user">
            ...
            <span class="sright">
              <el-checkbox
                :indeterminate="user.isIndeterminate"
                v-model="user.checkAll"
          ...
          <div class="user-slist">
            <el-checkbox-group
              v-model="user.checkedSystem"
              @change="userCheckedCitiesChange"
            >
              <el-checkbox
                v-for="item in user.systemList"
                :label="item"
                :key="item"
              >{{item}}</el-checkbox>
            </el-checkbox-group>
          ...
          <div class="message">
            <span class="sleft">
              <i
                class="iconfont icon-jia"
                @click="messageShow"
                v-show="message.sShow"
              ></i>
              <i
                class="iconfont icon-jian"
                @click="messageHide"
                v-show="message.sHide"
              ></i>
              消息管理
            </span>
            <span class="sright">
              <el-checkbox
                :indeterminate="message.isIndeterminate"
                v-model="message.checkAll"
                @change="messageCheckAllChange"
              >全选</el-checkbox>
            </span>
          </div>
          <div class="message-slist">
            <el-checkbox-group
              v-model="message.checkedSystem"
              @change="messageCheckedCitiesChange"
            >
              <el-checkbox
                v-for="item in message.systemList"
                :label="item"
                :key="item"
              >{{item}}</el-checkbox>
            </el-checkbox-group>
...
export default {
  ...
  methods: {
    ...
    informationCheckAllChange(val) {
      this.list(
        this.information.systemList,
        this.information.systemList,
        this.information.systemKey,
        2
      );
    ...
    equipmentCheckAllChange(val) {
      this.list(
        this.equipment.systemList,
        this.equipment.systemList,
        this.equipment.systemKey,
        3
      );
    ...
    personnelCheckAllChange(val) {
      this.list(
        this.personnel.systemList,
        this.personnel.systemList,
        this.personnel.systemKey,
        4
      );
    ...
    messageCheckAllChange(val) {
      this.list(
        this.message.systemList,
        this.message.systemList,
        this.message.systemKey,
        6
      );
    ...
    add() {
      ...
      this.axios
        .post(this.global.apiSrc + "/role/add", data, {
          params: { permissionIds: this.systemID }
        })
        .then(response => {
    ...
    listPermissionByRoleId(val) {
      this.axios
        .get(this.global.apiSrc + "/role/listPermissionByRole", {
          params: { roleId: val }
        })
        .then(response => {
          let arr = new Array();
