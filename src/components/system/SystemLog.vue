<template>
	<div class="system_log">
		<div class="top">
				...
				<el-form :inline="true" class="demo-form-inline">
					<el-form-item label="入库日期：" style="margin-bottom:0px;">
						...
						<el-date-picker
							...
							value-format="yyyy/MM/dd"
						></el-date-picker>
						<el-button size="small" type="primary" @click="beforeSearch">
			...
			<div class="search">
				<span>关键字：</span>
				<el-input type="search" placeholder="如单号、编号、名称、型号/规格、供货商" size="small" v-model="rkeyword"></el-input>
				<el-button size="small" type="primary" @click="beforeSearch">
			...
			this.Axios(
				...
				result => {
					...
					for (let i = 0; i < this.tableData.length; i++) {
						this.tableData[i].godownEntryTime = this.tableData[
							i
						].godownEntryTime.split(" ")[0];
					}
				},
				({ type, info }) => {}
			);
