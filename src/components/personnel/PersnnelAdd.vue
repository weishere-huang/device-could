            ...
            <ul>
              ...
              <li>
                ...
                <el-input
                  type="text"
                  size="small"
                  v-model="persnneladd.employeeNo"
                ></el-input>
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                <el-input
                  type="text"
                  size="small"
                  v-model="persnneladd.idCardNo"
                ></el-input>
              </li>
              <li>
                <label for="">角色权限：</label>
                <el-select
                  v-model="persnneladd.roleId"
                  placeholder="请选择"
                  size="small"
                  style="width:70%"
                >
          ...
          <ul>
            <li>
              <span>
                ...
                <el-input
                  ...
                  size="small"
                  style="width:80px"
                  v-model="persnneladd.workingYears"
                ></el-input>
                年
              </span>
            ...
            <li>
              <span>
                ...
                <el-input
                  ...
                  size="small"
                  style="width:200px"
                  v-model="persnneladd.nativePlace"
                ></el-input>
              ...
              <span style="display:inline-block;float:right;padding-right:123px">
                ...
                <el-input
                  ...
                  size="small"
                  style="width:80px"
                  v-model="persnneladd.nationality"
                ></el-input>
              </span>
            </li>
            <li>
            ...
            <li>
              ...
              <el-input
                ...
                size="small"
                style="width:200px"
                v-model="persnneladd.postalAddress"
              ></el-input>
            </li>
            <li>
              <span>
                ...
                <el-input
                  ...
                  size="small"
                  style="width:200px"
                  v-model="persnneladd.graduateSchool"
                ></el-input>
              </span>
              <span style="display:inline-block;float:right;padding-right:100px">
